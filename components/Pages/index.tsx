  ...
  return (
    <div style={{ direction: "ltr", minHeight: "11vh", }}>
      ...
      <Window title={"Weather Servies"} style={{ minHeight: 300, margin: 10, width: "calc(100% - 20px)", backgroundImage: 'url("https://cdn.ituring.ir/research/75/images.jpeg")', backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
        ...
        <c-x style={{}}>
          <f-25 style={{ padding: "10px 10px", color: "greenyellow", textAlign: "center", fontFamily: "readme" }}>Shiraz </f-25>
          <f-cse>
            <f-cc style={{ height: 80, width: 300, backgroundColor: "aqua", borderRadius: 15 }}>
            ...
            <f-cc style={{ height: 80, width: 300, backgroundColor: "dodgerblue", borderRadius: 15 }}>
          ...
          <f-cse>
            ...
            <f-cc style={{ height: 80, width: 300, backgroundColor: "royalblue", borderRadius: 15 }}>
          ...
          <f-cc style={{ width: "100%" }}>
            <sp-4 />
            <f-13>By Turing team (kepler group) </f-13>
